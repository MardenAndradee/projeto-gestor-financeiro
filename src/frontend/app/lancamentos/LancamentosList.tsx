    ...
    <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            >
              ...
              <div className="flex justify-between md:justify-end items-center gap-4 min-w-[120px]">
                ...
                <div className="flex items-center gap-2">
                  <button title="Editar" className="hover:text-blue-600 transition">
                    <PencilSquareIcon className="h-5 w-5 text-gray-600 hover:text-gray-700" />
                  </button>
                  <button title="Excluir" className="hover:text-red-600 transition">
      ...
      {showForm && (
        <LancamentoForm
          ...
          atualizarLancamentos={() => handleGetLancamentos(filtros)} // ✅ Atualiza ao adicionar
        />
      )}
    </div>
  );
