...
// Definindo o tipo Lancamento (igual ao que você usou em LancamentosPage)
...
// Definindo o tipo para os props do LancamentoForm
interface LancamentoFormProps {
  onAdd: (formData: Lancamento) => void;
  onClose: () => void;
}
...
export default function LancamentoForm({ onAdd, onClose }: LancamentoFormProps) {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    setFormData((prev) => ({
      ...prev,
      [name]: name === "valor" || name === "qtdParcelas" ? Number(value) : value,
    }));
  };
